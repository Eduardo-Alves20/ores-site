...
export default function Voluntario() {
  return (
    <div className="animate-page">
      <PageHeader eyebrow="Comunidade" title="Quero ser Voluntário" subtitle="Junte-se a nós! Há muitas formas de servir ao próximo." />
      <section style={{ padding:'72px 24px', maxWidth:1100, margin:'0 auto' }}>
        ...
        <Reveal>
          <div style={{ background:'var(--navy)', borderRadius:16, padding:'48px', textAlign:'center' }}>
            <h2 style={{ fontFamily:'Playfair Display,serif', fontSize:28, color:'#fff', fontWeight:700, marginBottom:16 }}>Pronto para servir?</h2>
            <p style={{ fontSize:15, color:'rgba(255,255,255,.65)', lineHeight:1.75, maxWidth:560, margin:'0 auto 32px' }}>Entre em contato com a secretaria paroquial ou nos envie uma mensagem. Teremos prazer em apresentar as oportunidades de voluntariado.</p>
            <Link to="/contato" style={{ display:'inline-flex', alignItems:'center', gap:6, padding:'14px 32px', borderRadius:100, background:'var(--gold)', color:'#fff', fontWeight:600, fontSize:15, boxShadow:'0 4px 18px rgba(184,148,90,.35)', transition:'transform .2s' }}
