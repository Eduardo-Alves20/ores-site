...
export default function Conheca() {
  ...
  return (
    <div className="animate-page">
      <PageHeader eyebrow="Paróquia" title="Conheça a PES" subtitle="Tudo sobre a Paróquia Espírito Santo de São José dos Campos." />
          ...
          <div>
            <Reveal>
              <div style={{ background:'#fff', borderRadius:12, border:'1px solid var(--border)', padding:'32px', marginBottom:24 }}>
                <h2 style={{ fontFamily:'Playfair Display,serif', fontSize:24, fontWeight:700, color:'var(--navy)', marginBottom:16 }}>Nossa História</h2>
                <p style={{ fontSize:15, color:'var(--text-mid)', lineHeight:1.75, marginBottom:16 }}>
                  A Paróquia Espírito Santo está localizada no Jardim Satélite, em São José dos Campos/SP. Com décadas de história, a paróquia serve a comunidade com fé, caridade e evangelização.
                </p>
                <p style={{ fontSize:15, color:'var(--text-mid)', lineHeight:1.75 }}>
                  Nossa missão é evangelizar, celebrar os sacramentos e promover o desenvolvimento integral da pessoa humana, à luz do Evangelho e do Magistério da Igreja.
                </p>
              </div>
            </Reveal>
