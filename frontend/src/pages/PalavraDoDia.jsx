  ...
  return (
    <div className="animate-page">
      <PageHeader
        ...
        subtitle="Leituras diárias em comunhão com a Igreja."
      />
          ...
          <Reveal>
            <div style={{ background: '#fff', border: '1px solid var(--border)', borderRadius: 14, overflow: 'hidden', boxShadow: '0 12px 36px rgba(26,39,68,.08)' }}>
              ...
              <div style={{ padding: '26px 24px' }}>
                ...
                {data?.content_html ? (
                  <div style={{ fontSize: 15, color: 'var(--text-mid)', lineHeight: 1.8 }} dangerouslySetInnerHTML={{ __html: data.content_html }} />
                ) : (
                  <p style={{ fontSize: 14, color: 'var(--text-soft)' }}>Conteúdo indisponível no momento.</p>
                )}
                {data?.link_url && (
                  <a
                    href={data.link_url}
